        ...
        <br/>
            ...
            <Row className="p-style">
                <Col md={4} >
                    ...
                    <Link to='/about' className="btn btn-warning" style={{margin:"5.5rem 0"}}>Read More</Link>
                </Col>
                ...
                <Col md={4}>
                    ...
                    *Collaborate with national and international institutions R&D establishments organizations like AICTE, MHRD, UGC, etc.industry and user agencies.
                    ...
                    <Link to='/about' className="btn btn-warning" style={{margin:"2rem 0"}}>Read More</Link>
                </Col>
            </Row>
       </Container> 
    )
